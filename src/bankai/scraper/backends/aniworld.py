"""aniworld.to scraper â€” anime series.

Sister site to bs.to; shares most of the markup conventions. Stubbed
pending real fixture HTML.
"""
...
@register
class AniworldBackend:
    site_id: ClassVar[str] = "aniworld"
    display_name: ClassVar[str] = "Aniworld"
    ...
    async def search(
        ...
        *,
        ...
        raise ScraperError("aniworld backend not yet implemented â€” capture fixture HTML first")

    async def list_episodes(self, series_url: str) -> list[EpisodeRef]:
        raise ScraperError("aniworld backend not yet implemented")
