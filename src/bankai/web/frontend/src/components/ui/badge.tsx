...
const badgeVariants = cva('inline-flex items-center rounded-full border px-2.5 py-0.5 text-[0.7rem] font-medium tracking-wide transition-colors', {
  variants: {
    variant: {
      ...
      queue: 'border-white/15 bg-queue text-foreground',
      starting: 'border-starting/40 bg-starting/20 text-starting',
      extract: 'border-extract/40 bg-extract/20 text-extract',
      torrent: 'border-torrent/40 bg-torrent/20 text-torrent',
